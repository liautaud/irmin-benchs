...
axs[0].legend()
axs[0].set_xlabel("Number of 4096-byte blocks read", fontstyle="italic", labelpad=10)
...
axs[1].legend()
axs[1].set_xlabel("Number of 4096-byte blocks written", fontstyle="italic", labelpad=10)
